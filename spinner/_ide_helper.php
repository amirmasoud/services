...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function as($generatingFileName, $hasExtension = true)
        {
                        /** @var \Touhidurabir\StubGenerator\StubGenerator $instance */
                        return $instance->as($generatingFileName, $hasExtension);
        }
                    /**
         * The name of the generating file extension
         *
