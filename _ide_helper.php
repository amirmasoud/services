...
namespace Illuminate\Support\Facades {
    ...
    class DB
    {
        ...
        {            //Method inherited from \Illuminate\Database\Connection
            SQLiteConnection::resolverFor($driver, $callback);
        }
        ...
        {            //Method inherited from \Illuminate\Database\Connection
            return SQLiteConnection::getResolver($driver);
        }
    ...
    class Schema
    {
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder
            SQLiteBuilder::defaultStringLength($length);
        }
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder
            SQLiteBuilder::defaultMorphKeyType($type);
        }
...
namespace {
    ...
    class ModelRepository extends StubGenerator
    {
    }
